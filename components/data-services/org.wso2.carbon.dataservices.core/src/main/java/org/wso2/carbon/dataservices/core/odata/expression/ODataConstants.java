...
public class ODataConstants {
	...
	public static final EdmPrimitiveType primitiveSByte =
			ODATA.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.SByte);
	public static final EdmPrimitiveType primitiveByte =
			ODATA.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.Byte);
	public static final EdmPrimitiveType primitiveInt16 =
			ODATA.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.Int16);
	public static final EdmPrimitiveType primitiveInt64 =
	...
	public static final EdmPrimitiveType primitiveDate =
			ODATA.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.Date);
	public static final EdmPrimitiveType primitiveTimeOfDay =
			ODATA.createPrimitiveTypeInstance(EdmPrimitiveTypeKind.TimeOfDay);
	public static final EdmPrimitiveType primitiveInt32 =
